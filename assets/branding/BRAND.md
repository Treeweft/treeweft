# Treeweft Brand Guidelines

## Logo

The Treeweft mark is the **Thread-Tree**: a woven canopy symbol combining vertical
...
- Dark: `assets/branding/treeweft-logo-horizontal.svg` (PNG: `treeweft-logo-horizontal.png`, 1600x320)
- Light: `assets/branding/treeweft-logo-horizontal-light.svg` (PNG: `treeweft-logo-horizontal-light.png`, 1600x320)

### Stacked Lockup

Mark above wordmark. Use in square spaces: app icons, avatars, profile photos.

- `assets/branding/treeweft-logo-stacked.svg` (PNG: `treeweft-logo-stacked.png`, 800x880)

### Mark Only

Standalone symbol. Use for favicons, app icons, social avatars.

- `assets/branding/treeweft-mark.svg` (PNG: `treeweft-mark.png`, 208x256)
- Favicon: `assets/branding/treeweft-favicon.svg` (32x32, dark bg, rounded; PNG: `treeweft-favicon.png`, 128x128)
- Avatar: `assets/branding/treeweft-avatar.png` (1000x1000, mark centered on the dark bg; the square profile image for Docker Hub, GitHub and social accounts)
...
- Maintain clear space around the mark equal to the height of the 't' in treeweft
