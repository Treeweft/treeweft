...
`python -m treeweft.benchmark agentic`), asserts per model:
...
def check_run(rows: list[dict], summary: dict, arm: str = "treeweft") -> list[str]:
...
def main(argv: list[str] | None = None) -> int:
    ...
    ap.add_argument("--arm", default="treeweft")
