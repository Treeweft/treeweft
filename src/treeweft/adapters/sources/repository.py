...
from treeweft.domain.sources import SourceRecord, SourceRepositoryPort
...
SOURCE_LIST_MAX = int(os.environ.get("TREEWEFT_SOURCE_LIST_MAX", "10000"))
            ...
            async with pool.acquire() as conn:
                ...
                if len(rows) == cap:
                    logger.warning(
                        ...
                        "truncated (raise TREEWEFT_SOURCE_LIST_MAX if intended)",
                        cap,
                    )
