...
_HMAC_SECRET = os.environ.get("TREEWEFT_HMAC_SECRET", "")
if not _HMAC_SECRET:
    _HMAC_SECRET = secrets.token_hex(32)
    logger.warning(
        "TREEWEFT_HMAC_SECRET not set — generated random secret. "
        "Set TREEWEFT_HMAC_SECRET for persistent API keys across restarts."
    )
