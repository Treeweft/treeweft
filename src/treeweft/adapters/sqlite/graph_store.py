...
function contract in `treeweft/graph_store.py:_EXPORTED`.

The graph Treeweft actually needs is modest: entity/relationship upserts,
...
GRAPH_DB_PATH = os.environ.get(
    "GRAPH_DB_PATH", str(Path.home() / ".treeweft" / "graph.db")
)
