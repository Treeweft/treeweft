...
from treeweft import embedder, graph_store, llm
...
async def search_graphs(query_text, query_embedding, top_k=10, language=None, source_id=None):
    ...
    from treeweft import retriever
    ...
    from treeweft.adapters.graph.community_adapter import get_community_summaries
