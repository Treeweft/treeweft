...
backend's functions so `from treeweft import graph_store` /
`from treeweft.graph_store import X` are backend-agnostic.
"""
import os
...
if _backend == "sqlite":
    from treeweft.adapters.sqlite import graph_store as _impl
else:
    from treeweft.adapters.neo4j import graph_store as _impl
