...
- `tei` (default): cost-aware proxy routing batches across TEI backends
  ...
  `treeweft.adapters.tei.embedding_proxy` and
...
if _provider == "openai":
    from treeweft.adapters.openai_api.embedding_adapter import (  # noqa: F401
        MAX_BATCH_SIZE,
        embed,
        embed_query,
    )
else:
    from treeweft.adapters.tei.embedding_proxy import (  # noqa: F401
        MAX_BATCH_SIZE,
        embed,
        embed_query,
        get_proxy,
