"""CLI entry: python -m treeweft.preflight <path> [options].
...
from treeweft.preflight.coefficients import (
    fallback_coefficients,
    load_coefficients,
    write_coefficients,
)
from treeweft.preflight.model import estimate_total
from treeweft.preflight.recommender import PreflightReport, build_report
...
async def _run_calibrate(source_id: str) -> int:
    ...
    from treeweft.adapters.postgresql.connection import init_pool, get_pool
...
def main(argv: list[str] | None = None) -> int:
    p = argparse.ArgumentParser(prog="python -m treeweft.preflight")
