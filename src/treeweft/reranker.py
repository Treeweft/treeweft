...
if _provider == "local":
    from treeweft.adapters.rerank.local_cross_encoder import rerank_texts  # noqa: F401
elif _provider == "local-st":
    from treeweft.adapters.rerank.st_cross_encoder import rerank_texts  # noqa: F401
elif _provider in _CLOUD_PROVIDERS:
    from treeweft.adapters.rerank.cloud_reranker import rerank_texts  # noqa: F401
else:
    from treeweft.adapters.rerank.http_reranker import rerank_texts  # noqa: F401
