...
A single retrieval-quality experiment that switches treeweft's two graph mechanisms
...
Treeweft's graph layer contributes in two distinct ways:
...
query names a specific identifier, the graph lets Treeweft find the definition
