...
**Evaluating Treeweft** (about an hour):

1. The [README](https://github.com/Treeweft/treeweft/blob/main/README.md): what Treeweft is, the "semantic search, not
...
10. [Benchmark eval workflow](benchmark-eval.md): how to measure grep versus
    Treeweft on your own repositories, with significance.
...
| Document | Class | Summary |
|---|---|---|
| [benchmark-results-2026-09.md](benchmark-results-2026-09.md) | Evidence, current headline | The September 2026 refresh on a pinned corpus with three current agents and an independent judge. Treeweft matched grep's answer quality at 11 to 47 percent lower cost; the correctness edge was not significant in any cell. The README table is copied from here. |
...
| [benchmark-findings.md](benchmark-findings.md) | Evidence, ledger | The full grep-versus-Treeweft record since the first run, in dated sections. Later sections qualify earlier ones, including the graph-rescoring re-validation under the production reranker. |
...
- [README.md](https://github.com/Treeweft/treeweft/blob/main/README.md): the public front door and Quick Start.
- [CONTRIBUTING.md](https://github.com/Treeweft/treeweft/blob/main/CONTRIBUTING.md): contribution gates, including that
  retrieval changes need a benchmark run.
- [SECURITY.md](https://github.com/Treeweft/treeweft/blob/main/SECURITY.md): how to report a vulnerability.
- [CLAUDE.md](https://github.com/Treeweft/treeweft/blob/main/CLAUDE.md): the short rulebook for maintainers and coding
...
- [assets/branding/BRAND.md](https://github.com/Treeweft/treeweft/blob/main/assets/branding/BRAND.md): logo files,
...
adr-004-compatibility-versioning
gpu-cpu-routing
```
