...
source pin. Mocks only the httpx boundary — never internal treeweft classes.
"""
import ast
import inspect
...
from treeweft.adapters.benchmark.llm_client import resolve_model_route
...
def test_agentic_runner_token_budgets_source_pinned():
    ...
    from treeweft.application.benchmark import agentic_runner
