...
from treeweft.adapters.benchmark.llm_client import FLOATING_ALIASES, is_floating_alias
from treeweft.application.benchmark.agentic_runner import enforce_floating_model_policy
...
def _no_env_override(monkeypatch):
    monkeypatch.delenv("TREEWEFT_ALLOW_FLOATING_MODELS", raising=False)
...
def test_guard_allows_via_env_var(monkeypatch, capsys):
    monkeypatch.setenv("TREEWEFT_ALLOW_FLOATING_MODELS", "1")
