...
from treeweft.domain.benchmark.agent_metrics import _arm_means
from treeweft.domain.benchmark.cost_model import PRICES, compute_cost, price_for
...
class TestUnpricedModelsAreLoud:
    def _summary(self, model):
        ...
        return _arm_means([{"arms": {"treeweft": arm}}], "treeweft", model)
