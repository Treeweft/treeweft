...
class TestIndexerSearchEndpoints:
    ...
    def test_search_endpoint(self, test_client, mocker):
        ...
        mock_embed = mocker.patch(
            "treeweft.application.indexer_service.embed_query",
            return_value=[[0.1, 0.2, 0.3]],
        )
        mock_gs = mocker.patch(
            "treeweft.application.indexer_service.graph_search",
            return_value={
                "chunks": [
                    {
    ...
    def test_find_definition_by_name(self, test_client, mocker):
        ...
        mock_find = mocker.patch(
            "treeweft.application.indexer_service.graph_store.find_entities_by_name",
            return_value=[
                {
    ...
    def test_find_callers(self, test_client, mocker):
        ...
        mock_callers = mocker.patch(
            "treeweft.application.indexer_service.graph_store.find_callers",
            return_value=[
                {
    ...
    def test_find_references(self, test_client, mocker):
        ...
        mock_refs = mocker.patch(
            "treeweft.application.indexer_service.graph_store.find_references",
            return_value=[
                {
