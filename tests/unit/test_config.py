"""Index-stamp check tunables (ADR-004 §3): defaults, overrides, and that a
malformed value fails validate_config() with a message naming the setting
(constitution V), instead of surfacing later as a runtime crash."""
