...
class TestSampleEntities:
    ...
    def test_population_smaller_than_k_returns_every_entity(self):
        ...
        from treeweft.application.benchmark.enhanced_query_gen import sample_entities
...
class TestOffDomainPrescreen:
    ...
    def _vocab(self):
        from treeweft.domain.benchmark.query_hygiene import build_vocab_lemmas
    ...
    def test_lemma_strips_gerund_and_collapses_doubling(self):
        from treeweft.domain.benchmark.query_hygiene import lemma
    ...
    def test_true_positive_off_domain_noun_flagged(self):
        from treeweft.domain.benchmark.query_hygiene import off_domain_terms
