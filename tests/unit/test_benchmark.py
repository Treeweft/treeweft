...
class TestResolveLlmConfig:
    ...
    def test_basic_tier_defaults(self, monkeypatch):
        ...
        from treeweft.adapters.benchmark.llm_client import resolve_llm_config
...
class TestMetrics:
    ...
    def test_recall_hit(self):
        ...
        from treeweft.domain.benchmark.metrics import compute_recall
        gt = ["/a.cs", "/b.py", "/c.ts"]
    ...
    def test_precision_partial_hit(self):
        ...
        from treeweft.domain.benchmark.metrics import compute_precision
        gt = ["/a.cs"]
    ...
    def test_mrr_first_position(self):
        ...
        from treeweft.domain.benchmark.metrics import compute_mrr
...
class TestSessionModelSearch:
    ...
    async def test_generates_patterns_from_llm_response(self):
        ...
        with patch.dict(os.environ, {
            ...
            from treeweft.adapters.benchmark.llm_client import session_model_search
