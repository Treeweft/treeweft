...
async def test_embed_calls_openrouter_with_correct_payload():
    ...
    from treeweft.adapters.openrouter.embedding_adapter import embed
    ...
    with patch("treeweft.adapters.openrouter.embedding_adapter._get_client", return_value=mock_client):
...
async def test_embed_handles_openrouter_error():
    ...
    with patch("treeweft.adapters.openrouter.embedding_adapter._get_client", return_value=error_client):
