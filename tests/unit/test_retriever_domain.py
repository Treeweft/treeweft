...
import pytest
from treeweft.adapters.milvus.vector_store import _build_filter, _cosine, _name_in_query
...
class TestFilterInjection:
    ...
    def test_trailing_backslash_cannot_swallow_the_closing_quote(self):
        ...
        from treeweft.adapters.milvus.vector_store import _escape_literal
