...
from treeweft.infrastructure.config import ConfigError
...
class TestCreateVectorStore:
    ...
    def test_backend_milvus(self):
        ...
        with patch(
            "treeweft.infrastructure.vector_store_factory.MilvusAdapter", mock_milvus
        ), patch(
            "treeweft.infrastructure.vector_store_factory.ChromaAdapter", mock_chroma
        ):
            from treeweft.infrastructure.vector_store_factory import create_vector_store
