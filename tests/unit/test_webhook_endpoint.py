...
def test_webhook_valid_github_returns_202(
    ...
    with patch(
        "treeweft.adapters.webhook.github.GitHubAdapter.handle_webhook",
        ...
        with patch(
            ...
            with patch(
                "treeweft.application.indexer_runners._run_index_repo_job",
                new_callable=AsyncMock,
            ), patch(
                "treeweft.application.routes_webhook._find_active_job_for_source",
                new_callable=AsyncMock, return_value=None,
            ), patch(
                "treeweft.application.indexer_runners._persist_job",
                new_callable=AsyncMock,
            ), patch(
                "treeweft.application.indexer_state._job_queue",
