...
from treeweft.preflight.coefficients import Coefficients, fallback_coefficients
from treeweft.preflight.model import estimate_total, estimate_file
from treeweft.preflight.recommender import build_report
from treeweft.preflight.scanner import FileStat, walk_repo
...
def test_build_report_skip_patterns_gated_by_feature_flag(monkeypatch):
    ...
    monkeypatch.setenv("TREEWEFT_FEATURE_SKIP_PATTERNS", "0")
