...
re-export in `treeweft.graph_store`. It is one caller away from being so, and
...
class TestBothBackendsAgree:
    ...
    def test_neither_adapter_keeps_its_own_copy_of_the_rule(self):
        ...
        from treeweft.adapters.neo4j import graph_store as n4
        from treeweft.adapters.sqlite import graph_store as sq
