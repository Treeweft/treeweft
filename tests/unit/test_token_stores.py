...
class TestTokenStoreCreate:
    ...
    async def test_create_returns_dataclass(self):
        ...
        from treeweft.domain.authorization import PersonalAccessToken
...
class TestApiKeyStoreCreate:
    ...
    async def test_create_returns_dataclass(self):
        ...
        from treeweft.domain.authorization import ApiKey
...
class TestSessionStoreCreate:
    ...
    async def test_create_returns_dataclass(self):
        ...
        from treeweft.domain.authorization import Session
