...
- [ ] Retrieval-quality changes only: benchmark run attached or linked (`python -m treeweft.benchmark run ...`, see docs/benchmark-eval.md), including the reference set and the before/after recall@k / MRR
